...
Lambda code is a new high level compiled statically typed programming language. Written in python, C, C++. Its [syntax](syntax.md) is far more simplrer than other middle level compiled languages like C, C++.
